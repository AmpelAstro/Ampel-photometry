# -*- coding: utf-8 -*-
#
# Ampel documentation build configuration file, created by
...
intersphinx_mapping = {
    ...
    'ampel-interface': ('https://ampelproject.github.io/Ampel-interface', None),
    'ampel-core': ('https://ampelproject.github.io/Ampel-core', None),
}
